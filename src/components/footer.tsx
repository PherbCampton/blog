    ...
    <footer className="footer mb-16 mt-32 pb-5">
      <div className="flex w-full justify-between">
        <div className="grid w-[59%] grid-cols-1 gap-6 lg:grid-cols-3">
          <div className="external-hover pl-8 lg:pl-10">
            <div className="mb-6">Services</div>
            <ul>
              <li>
                <a href="/raas" className="">
                  <span>Rollup-as-a-Service</span>
                </a>
              </li>
              <li>
                <a href="/automate" className="">
                  <span>Automate</span>
                </a>
              </li>
              <li>
                <a href="/relay" className="">
                  <span>Relay</span>
                </a>
              </li>
              <li>
                <a href="/web3-functions" className="">
                  <span>Web3 Functions</span>
                </a>
              </li>
              <li>
                <a href="/vrf" className="">
                  <span>VRF</span>
                </a>
              </li>
            </ul>
          ...
          <div className="external-hover pl-8 lg:pl-10">
            <div className="mb-6">Governance</div>
            <ul>
              <li>
                <a href="https://forum.gelato.network/" target="_blank">
                  {" "}
                  Forum{" "}
              ...
              <li>
                <a href="https://snapshot.org/#/gelato.eth" target="_blank">
                  {" "}
                  Voting{" "}
                  <i className="ml-1 inline-block">
                    <svg
          ...
          <div className="external-hover pl-8 lg:pl-10">
            ...
            <ul>
              <li>
                <a
                  id="footernav-documentation"
                  href="https://docs.gelato.network/introduction/what-is-gelato"
                  target="_blank"
                >
                  {" "}
                  Documentation{" "}
              ...
              <li>
                <a
                  id="footernav-github"
                  href="https://github.com/gelatodigital"
                  target="_blank"
                >
                  {" "}
                  Github{" "}
              ...
              <li>
                <a
                  id="footernav-discussions"
                  href="https://github.com/orgs/gelatodigital/discussions"
                  target="_blank"
                >
                  {" "}
                  Discussions{" "}
        ...
        <div className="grid w-[39%] grid-cols-1 gap-6 lg:grid-cols-2">
          <div className="external-hover pl-0 lg:pl-10">
            ...
            <ul>
              ...
              <li>
                <a href="/gelato-ambassador-program" className="">
                  Ambassador
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/brand-assets" className="">
                  Brand Assets
                </a>
              </li>
              <li>
                <a
                  href="https://docs.gelato.network/gelato-dao/dao-and-token-gel"
          ...
          <div className="pl-0 lg:pl-10">
            ...
            <ul>
              ...
              <li>
                <a
                  id="footernav-youtube"
                  href="https://www.youtube.com/channel/UCBk9gXYKOoLHTQxpcnZkBwQ"
                  target="_blank"
                >
      ...
      <div className="mt-16 flex flex-col flex-wrap justify-between pl-8 text-sm lg:flex-row lg:flex-nowrap lg:pl-10">
        ...
        <ul className="mt-2 flex gap-2 pr-8 lg:mt-0">
          <li>
            <a
              href="/docs/Gelato_Terms_of_Service.pdf"
          ...
          <li>
            <a
              href="/docs/Gelato_Privacy_Policy.pdf"
              className="opacity-40 hover:opacity-100"
              target="_blank"
            >
              {" "}
